        ...
        <div className='w-full h-full'>
            ...
            <div className='w-full lg:px-[60vh] h-full flex flex-col justify-center items-center bg-white text-bold p-8'>
                ...
                <div className=' w-[80vw] flex flex-col lg:flex-row justify-center items-center'>
                    ...
                    {/* BG Color Div */}
                    <div className='justify-center items-center rounded-2xl bg-[#ffe5ec] flex flex-col h-full p-4 sm:p-8 space-y-8'>
                            ...
                            {/* Buttons List */}
                                <div className='flex flex-col items-start justify-center gap-6'>
                                    <div className='flex flex-row gap-2 items-center justify-between w-full'>
                                        ...
                                        <p className='text-xl  lg:text-left text-left flex flex-row items-center'>
                                            <Mail className='h-6 w-6 mr-2'/> Antonette@antonettemorrison.com
                                        </p>
                                        <button onClick={() => 
                                            window.location.href = 'mailto:antonette@antonettemorrison.com'} 
                                            className=" flex justify-center items-center bg-black text-white text-xl md:text-2xl font-bold h-10 w-10  rounded hover:scale-110 transition duration-300"
                                        >
                                            <ArrowUpRight className='h-6 w-6 text-white'/>
                                        </button>
                                    </div>
                                    <div className='flex flex-row gap-2 items-center justify-between w-full'>
                                        <p className='text-xl  text-left flex flex-row items-center'>
                                            <Phone className='h-6 w-6 mr-2'/> (647) - 568 - 8772
                                        </p >
                                        <button
                                    ...
                                    <div className='flex flex-row gap-2 items-center justify-between w-full' >
                                        ...
                                        <p className='text-xl  text-left flex flex-row items-center'>
                                        <MapPin className='h-6 w-6 mr-2'/> 642 The Queensway Main Floor
                                        <br></br>
